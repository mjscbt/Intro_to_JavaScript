 ...
 * let JavaScript do it!). Next, create a variable called tip and assign
 * it the result of multiplying bill by a 15% tip rate.
 * Finally, add the bill and tip together and store it into a variable
 * called total. Print the total to the JavaScript console.
 *
